...
def playoff_form(team1, team2, team3, team4):
    with st.form(key=f"playoff_form"):
        ...
        with col1:
            ...
            score2 = st.number_input(label=f"Score for {team2_names}", key=f"score_playoff_1", min_value=0)
        ...
        with col2:
            ...
            score4 = st.number_input(label=f"Score for {team4_names}", key=f"score_playoff_1", min_value=0)
