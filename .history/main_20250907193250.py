...
def match_form(match_id, team1, team2, team3, team4):
...
if "player_name_dict" in st.session_state and st.session_state.player_name_dict:
    match_form(1, "Team 1", "Team 2", "Team 3", "Team 4")
    match_form(2, "Winner Match 1", "Winner Match 2", "Loser Match 1", "Loser Match 2")
    match_form(3, "Winner Match 3", "Winner Match 4", "Loser Match 3", "Loser Match 4")
    match_form(4, "Final Winner", "Final Loser", "Third Place Winner", "Third Place Loser")
