...
if "player_name_dict" in st.session_state and st.session_state.player_name_dict:
    ...
    match_form(round_number=2,team1=[4,7], team2=[7,8], team3=[2,3], team4=[4,6])
    match_form(round_number=3,team1=[1,5], team2=[7,8], team3=[2,3], team4=[4,6])
    match_form(round_number=4,team1=[1,5], team2=[7,8], team3=[2,3], team4=[4,6])
