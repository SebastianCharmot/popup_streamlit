...
def visualize_playoffs():
    if "playoff_scores" in st.session_state and st.session_state.playoff_scores:
        ...
        st.write(f"Semifinal 1: {team1_names} ({semifinal_1[0]}) vs {team4_names} ({semifinal_1[1]})")
        st.write(f"Semifinal 2: {team2_names} ({semifinal_2[0]}) vs {team3_names} ({semifinal_2[1]})")
        ...
        if "gold_medal_scores" in st.session_state and st.session_state.gold_medal_scores:
            ...
            st.write(f"Gold Medal Match: {gold_team1_names} vs {gold_team2_names}")
            st.write(f"Game 1: {gold_team1_names} ({gold_scores['game_1'][0]}) vs {gold_team2_names} ({gold_scores['game_1'][1]})")
            st.write(f"Game 2: {gold_team1_names} ({gold_scores['game_2'][0]}) vs {gold_team2_names} ({gold_scores['game_2'][1]})")
            if gold_scores["game_3"]:
                st.write(f"Game 3: {gold_team1_names} ({gold_scores['game_3'][0]}) vs {gold_team2_names} ({gold_scores['game_3'][1]})")
        ...
        if "bronze_medal_score" in st.session_state and st.session_state.bronze_medal_score:
            ...
            st.write(f"Bronze Medal Match: {bronze_team1_names} ({bronze_score['team1']}) vs {bronze_team2_names} ({bronze_score['team2']})")
